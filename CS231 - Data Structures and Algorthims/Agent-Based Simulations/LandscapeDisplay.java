...
public class LandscapeDisplay 
{
    ...
    public LandscapeDisplay(Landscape scape)
    {
        ...
        Dimension d = Toolkit.getDefaultToolkit().getScreenSize(); // https://alvinalexander.com/blog/post/jfc-swing/how-determine-get-screen-size-java-swing-app
        this.win.pack();
        this.win.setLocation(d.width/2-this.win.getSize().width/2,d.height/2-this.win.getSize().height/2); // https://docs.oracle.com/javase/7/docs/api/javax/swing/JFrame.html  ->  https://docs.oracle.com/javase/7/docs/api/java/awt/Component.html
